                ...
                <div style='display: flex; gap: 10px;'>
                    ...
                    <form method="GET" action="">
                        <div class="btn-group" role="group" aria-label="View options">
                            <button type="submit" name="view" value="list" class="btn btn-outline-primary <?php echo (isset($_GET['view']) && $_GET['view'] == 'list') ? 'active' : ''; ?>">Lista</button>
                            <button type="submit" name="view" value="thumbnails" class="btn btn-outline-primary <?php echo (isset($_GET['view']) && $_GET['view'] == 'thumbnails') ? 'active' : ''; ?>">Miniatury</button>
                            <button type="submit" name="view" value="details" class="btn btn-outline-primary <?php echo (isset($_GET['view']) && $_GET['view'] == 'details') ? 'active' : ''; ?>">Szczegóły</button>
                        </div>
                    </form>
                    ...
                    if (empty($files)) {
                        ...
                        foreach ($files as $file) {
                            ...
                            if($view_mode == 'list'){//lista
                                if (is_dir($full_path)) {//foldery
                                    echo "<li style='display: flex; align-items: center; gap: 10px; margin-bottom: 20px;'>
                                            <strong>Folder:</strong> 
                                            <a href='podkatalog.php?dir=" . $current_dir . "/" . $file . "&view=$view_mode'>$file</a>
